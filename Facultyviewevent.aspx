<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Facultyviewevent.aspx.cs" Inherits="WebApplication1.Facultyviewevent" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Faculty Control Panel(View Event)</h4>
                        </center>
                     </div>
                  </div>
                  <div class="row">
