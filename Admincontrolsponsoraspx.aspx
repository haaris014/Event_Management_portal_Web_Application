<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admincontrolsponsoraspx.aspx.cs" Inherits="WebApplication1.Admincontrolsponsoraspx" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Admin Control Panel(Individual Sponsorship)</h4>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-8">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Sponsor Name"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                   <br>
